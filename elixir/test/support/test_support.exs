defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    ...
    hook_before_terminal = Keyword.get(config, :hook_before_terminal)
    ...
    sections =
      [
        ...
        hooks_yaml(hook_after_create, hook_before_run, hook_before_terminal, hook_after_run, hook_before_remove, hook_timeout_ms),
  ...
  defp hooks_yaml(hook_after_create, hook_before_run, hook_before_terminal, hook_after_run, hook_before_remove, timeout_ms) do
    [
      "hooks:",
      "  timeout_ms: #{yaml_value(timeout_ms)}",
      hook_entry("after_create", hook_after_create),
      hook_entry("before_run", hook_before_run),
      hook_entry("before_terminal", hook_before_terminal),
